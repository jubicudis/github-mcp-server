...
// Change test package to 'ghmcp_test' to match new package name
package ghmcp_test
...
func TestClientAdapter(t *testing.T) {
	...
	legacyClient := ghmcp.NewClientCompatibilityAdapter(opts)
...
// Canonical test file for client_adapter.go
// All tests must directly and robustly test the canonical logic in client_adapter.go
...
// All test cases must match the actual signatures and logic of client_adapter.go
